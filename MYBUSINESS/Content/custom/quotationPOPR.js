...
function OnTypeSupplierName(param) {
    $(param).mcautocomplete({
        ...
        select: function (event, ui) {
            ...
            update_itemTotal();
            //document.getElementById('name' + txtSerialNum).focus(); //due to quotation
            return false;
        }
...
function TriggerFooterEvents() {
    ...
    $("#paid").keyup(function () {
        ...
        if (IsReturn == 'false') {
            //$("#CreatePO").html("Pay " + paid);//due to quotation
            $("#CreatePO").html("Pay ");
        }
        else {
            $("#CreatePO").html("Return "); //due to quotation
...
function update_itemTotal() {
    ...
    if (IsReturn == 'false') {
        ...
        $("#CreatePO").html("Return ");
        //$("#CreatePO").html("Return " + paid); //due to quotation
    }
