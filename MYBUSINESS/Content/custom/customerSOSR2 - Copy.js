var productColumns = [{ name: 'Id', minWidth: '100px' }, { name: 'Product', minWidth: '420px' }, { name: 'Sale Price', minWidth: '150px' }, { name: 'Stock', minWidth: '100px' }, { name: 'PerPack', minWidth: '100px' }, { name: 'P.P', minWidth: '50px' }, { name: 'W.S.P', minWidth: '50px' }];
    ...
    $(param).mcautocomplete({
        ...
        select: function (event, ui) {
            ...
            if (pfound == 0) {
                ...
                $('#purchasePrice' + clickedIdNum).val(ui.item ? ui.item[5] : '');
                //document.getElementById(clickedTextboxId).focus();
                update_itemTotal();
...
$(document).ready(function () {
    ...
    $("#addNewRow").click(function (e) {
        ...
        var row = '<tr>' +
            ...
            '<td><input type="text"  class="form-control autocomplete="off" classBGcolor" name="SaleOrderDetail[' + txtSerialNum + '].PurchasePrice" id="purchasePrice' + txtSerialNum + '"></td>' +
